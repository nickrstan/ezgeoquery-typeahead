...
First, get your *free* API key from [Ez Geo Query](https://ezgeoquery.us/). You can then begin to query our endpoints. Currently Ez Geo Query API has two endpoints available.
